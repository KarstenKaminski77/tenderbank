...
if(isset($_POST['terms'])){
	...
	mysql_query("UPDATE tbl_terms SET Content = '$terms'")or die(mysql_error());
                            ...
                            <tr>
                              <td><div id="list-border">
                                <table border="0" cellspacing="3" cellpadding="2">
                                  <tr>
                                    <td class="td-header">&nbsp;Terms &amp; Conditions</td>
                                  </tr>
                                  <tr>
                                    <td class="even"><textarea name="terms" cols="45" rows="5" class="backend-tarea" id="terms"><?php echo $row_Recordset1['Content']; ?></textarea></td>
                                  </tr>
                                  <tr>
