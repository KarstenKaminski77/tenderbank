...
$base_url='http://www.kwd.co.za';  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/kwd_inv/js/source/'; // path from base_url to base of upload folder (with start and final /)
